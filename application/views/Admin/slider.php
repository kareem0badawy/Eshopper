      ...
      <div class="content-wrapper">
        <?php $this->load->view('Admin/include/nav'); ?>
          ...
          <i class="fa fa-sliders" style="font-size:24px">&nbsp;&nbsp;Home Slider</i>
             <br>
             <br>
               <a href="<?php echo site_url("Controlpanel/createSlider")?>" class="btn btn-primary">
               Create Slider
               </a>
    ...
    foreach ($slider as $key => $row):?>
      ...
      <?php else: ?>
       ...
       <?php endif;?>
          ...
          <td>
              <a class="btn btn-primary" href="<?php echo site_url('Controlpanel/edit_slider/'.$row->id) ?>"><i class="fa fa-pencil-square-o"></i></a>
