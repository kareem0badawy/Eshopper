...
<section class="sidebar">
          ...
          <li>
            ...
            <!--StartDashboard-->
               <li class="treeview">
              <a href="<?php echo site_url("Controlpanel/panel")?>">
                <i class="fa fa-database" style="font-size: 24px"></i> <span>&nbsp;&nbsp;Data</span><i class="fa fa-angle-left pull-right"></i>
              </a>
              ...
              <a href="<?php echo site_url("Controlpanel/pages")?>">
               ...
               <ul class="treeview-menu">
                <li>
                    <a href="#"><i class="fa fa-users">&nbsp;&nbsp;All</i></a>
                </li>

                <li>
                      <a href="#"><i class="fa fa-user-secret">&nbsp;&nbsp;Managers</i></a>
                </li>
                <li>
