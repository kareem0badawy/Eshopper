  ...
  <?php $this->load->view('Admin/include/header'); ?>
      ...
      <div class="content-wrapper">
       ...
       <?php $this->load->view('Admin/include/nav'); ?>
        ...
        <br>
        <br>
      <form class="form-horizontal" action="<?php echo site_url('Controlpanel/create_footer');?>" method="post">
            <fieldset>
                ...
                <div class="form-group">
                 ...
                 <!-- File Image --> 
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="textinput" name="sort" type="text"  class="form-control input-md">
                    </div>
                </div>
